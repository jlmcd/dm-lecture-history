...
class App extends Component {
  ...
  getVehicles() {
    ...
    axios
      ...
      .then(res => {
        ...
        toast.success('Retrieved All Vehicles')
      })
      .catch(() => {
        toast.error('Failed to Get All Vehicles')
      })
  }
  ...
  sellCar(id) {
    ...
    axios
      ...
      .catch(() => {
        toast.error(`Can't sell that one`)
      })
  }
  ...
  addCar() {
    ...
    // axios (POST)
    // setState with response -> vehiclesToDisplay
    axios.post(`https://joes-autos.herokuapp.com/api/vehicles`, newCar) // newCar is the body object
      .then(res => {
        // console.log(res.data)
        this.setState({vehiclesToDisplay: res.data.vehicles})

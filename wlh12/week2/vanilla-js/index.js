...
box.style.border = '5px solid navy'
...
// SECOND - Modify the element however you want (styles, text, etc.)
newParagraph.innerText = 'Im a new paragraph'

// THIRD - Append the element onto an existing element
const main = document.querySelector('#main')
main.append(newParagraph)


// DELETING ELEMENTS
const oldP = document.querySelector('#main>.old-paragraph')
oldP.remove()
